...
interface BaseUnicode {
  ...
  hanzi: { base: string, desc: string, radical: string }
  latin: { base: string, combine: string }
  ellinika: { base: string, combine: string }
  kirillica: { base: string, combine: string }
  kana: {
    base: string
    small: string
    combine: string
  ...
  eonmun: { base: string, letter: string, half: string }
  zhuyin: {
    base: string
    initial: string
    medial: string
...
interface Unicode extends BaseUnicode {
  cjk: BaseUnicode['hanzi']
  greek: BaseUnicode['ellinika']
  cyrillic: BaseUnicode['kirillica']
  hangul: BaseUnicode['eonmun']
}

const baseUnicode: BaseUnicode = {
  /**
...
export const TYPESET = {
  ...
  'char': {
    ...
    greek: new RegExp(`(${rGk})`, 'gi'),
    ellinika: new RegExp(`(${rGk})`, 'gi'),
    cyrillic: new RegExp(`(${rCy})`, 'gi'),
   ...
   */
  'jinze': {
    hanging: new RegExp(`${rWhite}*([、，。．])(?!${rBDEnd})`, 'g'),
